...
12. **No linting or formatting tools** — There are no `.eslintrc`, `.prettierrc`, or `editorconfig` files. Follow existing code style when making changes.
