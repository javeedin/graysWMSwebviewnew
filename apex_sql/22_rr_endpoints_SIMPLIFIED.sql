-- ============================================================================
-- SIMPLIFIED FIX: GET /rr/endpoints - Without nested function
-- ============================================================================
-- Handles all 42 columns with inline CLOB handling
-- ============================================================================
...
DECLARE
    ...
    -- ALL 42 columns from the cursor
...
BEGIN
    ...
    IF v_status = 'SUCCESS' THEN
        ...
        LOOP
            ...
            -- Build JSON - basic fields only (skip CLOBs for now)
            HTP.p('{');
...
/*
This version:
- Fetches all 42 columns correctly
- Skips the CLOB fields in JSON output (for now)
- No nested function (which was causing the 555 error)
- Should work without errors

Once this works, we can add CLOB fields back if needed.
*/
