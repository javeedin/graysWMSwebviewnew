            ...
            <div style="background:#ffffff;border-radius:14px;width:95vw;max-width:1100px;max-height:92vh;display:flex;flex-direction:column;box-shadow:0 24px 80px rgba(0,0,0,0.25);overflow:hidden;border:2px solid #e2e8f0;">
                ...
                <div style="padding:0.85rem 1.2rem;background:#f8fafc;border-bottom:1px solid #e2e8f0;display:flex;align-items:center;gap:0.75rem;flex-shrink:0;">
                    ...
                    <button onclick="
                        ...
                        pop.style.cssText='position:absolute;top:3.5rem;left:1rem;right:1rem;background:#0f172a;border:1px solid #0e7490;border-radius:8px;padding:0.75rem 1rem;z-index:100000;box-shadow:0 8px 32px rgba(0,0,0,0.5);';
                        pop.innerHTML=\`<div style='display:flex;justify-content:space-between;align-items:center;margin-bottom:0.5rem;'><span style='color:#7dd3fc;font-size:10px;font-weight:700;'><span style='background:#059669;color:white;padding:1px 6px;border-radius:3px;margin-right:6px;'>GET</span>API Endpoint</span><button onclick='document.getElementById(\"sa-lines-api-popup\").remove()' style='background:none;border:none;color:#94a3b8;cursor:pointer;font-size:14px;'>×</button></div><div style='display:flex;gap:4px;'><input readonly value='${esc(getUrl)}' onclick='this.select()' style='flex:1;background:#1e293b;color:#38bdf8;border:1px solid #0e7490;border-radius:4px;padding:6px 8px;font-family:monospace;font-size:11px;width:100%;cursor:pointer;' title='Click to select'><button onclick='navigator.clipboard.writeText(\"${esc(getUrl)}\").then(()=>{this.textContent=\"✓\";setTimeout(()=>this.textContent=\"📋\",1200)})' style='background:#0e7490;color:white;border:none;border-radius:4px;padding:6px 8px;cursor:pointer;flex-shrink:0;font-size:12px;'>📋</button></div>\`;
