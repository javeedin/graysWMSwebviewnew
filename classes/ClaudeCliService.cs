...
namespace WMSApp
{
    ...
    public class ClaudeCliService
    {
        ...
        private const string PROMPT_TEMPLATE_MARKER = "FUSION-CATALOG-V36";
        ...
        public async Task<int> PrepareWorkspaceAsync(bool forceRefresh)
        {
            ...
            sb.AppendLine("    RULES INSIDE THE DIALOG - the form has a built-in rules engine, and this is the ONLY way trained validations reach it (your chat turns cannot touch the dialog's behavior). When the matched process (e.g. order.creation) carries companion-line rules or validations, TRANSLATE them into these two _lookups keys every time you open order.create:");
