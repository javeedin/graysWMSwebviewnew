-- ============================================================================
-- RR_GL_JOURNAL_BATCHES POST HANDLER - FINAL VERSION
-- Description: Direct field extraction from JSON_TABLE
-- Method: POST - Supports both single batch and Oracle Fusion "items" format
-- Endpoint: /rr/gl/journalbatches
-- Updated: 2025-11-10
-- ============================================================================
-- NOTE: ORDS automatically replaces existing handlers when you redefine them
-- ============================================================================
...
BEGIN
    ...
    IF v_has_items THEN
        -- Oracle Fusion format: Extract all fields directly from JSON_TABLE
        FOR batch IN (
            SELECT *
...
END;
        ...
        p_comments       => 'POST - Direct field extraction, supports Fusion items and direct batch format'
    );
...
PROMPT ✅ Using JSON_EXISTS for format detection
PROMPT ✅ Using direct field extraction from JSON_TABLE
